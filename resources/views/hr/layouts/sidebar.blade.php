...
<nav class="sidebar">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="{{route('hrdashboard')}}" class="nav-link">
              <i class="link-icon" data-feather="box"></i>
              <span class="link-title">Dashboard</span>
            </a>
            <li class="nav-item">
            <a href="{{route('fullcal')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('time.create')}}" class="nav-link">
              ...
              <span class="link-title">Time settings</span>
            </a>
          </li>
          </li>
          ...
          <!-- <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{route('hodleave.index')}}" class="nav-link">Pending Leave Requests</a>
                </li>
                <li class="nav-item">
                  <a href="{{route('allhodleave.index')}}" class="nav-link">All Leaves</a>
                </li>
                <li class="nav-item">
                  <a href="pages/email/compose.html" class="nav-link">Declined Leaves</a>
                </li>
              </ul>
            </div>
          </li> -->
