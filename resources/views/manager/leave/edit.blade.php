    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('managerleave.update',$leave->id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    @method('PUT')
                    ...
                    <div class="form-group">
                        <label for="example1">Head of Department Stamp(Initials)</label>
                        <input type="text" class="form-control" id="example1" value="{{$leave->Hodstamp}}" placeholder="Enter your initials" name="Hodstamp">
                    </div>
                    <div class="form-group">
                        <label for="example3">Manager Stamp(Initials)</label>
                        <input type="text" class="form-control" id="example3" value="{{$leave->managerstamp}}" placeholder="Enter your initials" name="managerstamp" >
                    </div>
