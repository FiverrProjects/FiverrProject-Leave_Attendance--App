                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                @if($leave->status == 1)
                                <a href="{{ route('managerleave.edit',$leave->id) }}">
                                ...
                                <form method="post" action="{{ route('managerdecline.leave',$leave->id) }}" id="decline-form-{{ $leave->id }}" style="display: none">
                                @csrf
                                @method('PUT')
                                </form>
                                ...
                                <form method="post" action="{{ route('managerapprove.leave',$leave->id) }}" id="approve-form-{{ $leave->id }}" style="display: none">
                                @csrf
                                @method('PUT')
                                </form>
                                @endif  
                                ...
                                <form id="delete-form-{{ $leave->id }}" action="{{ route('managerleave.destroy',$leave->id) }}" method="POST" style="display: none;">
                                @csrf
                                @method('DELETE')
                                </form>                                 
                                </td>
