          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{route('managerleave.index')}}" class="nav-link">Pending Leave Requests</a>
                </li>
                <li class="nav-item">
                  <a href="{{route('allmanagerleave.index')}}" class="nav-link">All Leaves</a>
                </li>
                <!-- <li class="nav-item">
                  <a href="pages/email/read.html" class="nav-link">Pending Leaves</a>
                </li>
                <li class="nav-item">
